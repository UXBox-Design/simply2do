		...
		return (
			<div className="login-success">
				...
				<div className="login-success__content">
					<p className="blurb">
						Hey guys! Thanks for using Simply2do. If you would like to contribute or perhaps you&apos;ve discovered a bug and have the fix, feel free to submit a <a className="pull-request" href="https://github.com/BuckyMaler/simply2do" target="_blank">pull request</a>. It would be greatly appreciated!
